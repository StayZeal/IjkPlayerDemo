...
/**
 * MiniVideoView 外边的MultiStateView必须用MiniMultiStateView
 */
public class MiniMultiStateView extends FrameLayout {
    ...
    public MiniMultiStateView(Context context) {
        this(context, null);
    }

    public MiniMultiStateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MiniMultiStateView(Context context, AttributeSet attrs, int defStyle) {
